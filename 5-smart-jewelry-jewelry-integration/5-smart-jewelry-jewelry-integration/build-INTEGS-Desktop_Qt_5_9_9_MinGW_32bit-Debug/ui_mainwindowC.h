...
public:
    ...
    void setupUi(QMainWindow *MainWindowC)
    {
        ...
        menubar = new QMenuBar(MainWindowC);
        menubar->setObjectName(QStringLiteral("menubar"));
        menubar->setGeometry(QRect(0, 0, 1285, 26));
        MainWindowC->setMenuBar(menubar);
    ...
    {
        MainWindowC->setWindowTitle(QApplication::translate("MainWindowC", "Gestion des clients", Q_NULLPTR));
        label->setText(QApplication::translate("MainWindowC", "Gestion des commandes ", Q_NULLPTR));
        statistiques->setText(QApplication::translate("MainWindowC", "stat par statut", Q_NULLPTR));
        ajout->setText(QApplication::translate("MainWindowC", "ajout", Q_NULLPTR));
        label_3->setText(QApplication::translate("MainWindowC", "recherche par num", Q_NULLPTR));
        envoyer->setText(QApplication::translate("MainWindowC", "envoyer", Q_NULLPTR));
        pushButton_supp->setText(QApplication::translate("MainWindowC", "supp", Q_NULLPTR));
        label_stat->setText(QString());
        total_de_la_commande->setText(QApplication::translate("MainWindowC", "Total de la commande", Q_NULLPTR));
        N_de_la_commande->setText(QApplication::translate("MainWindowC", "N\302\260 de la commande", Q_NULLPTR));
        date_de_la_commande->setText(QApplication::translate("MainWindowC", "Date de la commande", Q_NULLPTR));
        historique->setText(QApplication::translate("MainWindowC", "historique", Q_NULLPTR));
        modif->setText(QApplication::translate("MainWindowC", "MODIFIER", Q_NULLPTR));
        label_chatbot_response->setText(QString());
        tri->setText(QApplication::translate("MainWindowC", "tri par total", Q_NULLPTR));
        recherche_pushButton->setText(QApplication::translate("MainWindowC", "rechercher", Q_NULLPTR));
        statut_de_la_commande->setText(QApplication::translate("MainWindowC", "Statut de la commande", Q_NULLPTR));
        pdf->setText(QApplication::translate("MainWindowC", "PDF", Q_NULLPTR));
    } // retranslateUi
