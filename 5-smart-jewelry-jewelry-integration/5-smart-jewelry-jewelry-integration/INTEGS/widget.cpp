...
#include"jaafer/jaaferwindows.h"
...
void widget::on_pushButton_prod_2_clicked()
{
    this->hide();
    MainWindow1 *auth = new MainWindow1 ;
    auth->show();
}

void widget::on_pushButton_prod_3_clicked()
{
    this->hide();
    jaaferwindows *auth = new jaaferwindows ;
    auth->show();
}
