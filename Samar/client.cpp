...
bool Client::modifier(  )
{
    QSqlQuery query;
        ...
        query.prepare("UPDATE CLIENT SET NOM_C=:nom,PRENOM_C=:prenom,SEXE_C=:sexe ,DATE_DE_NAISSANCE_C=:date,AGE_C=:age,NUMERO_DU_TELEPHONE_C=:phone,EMAIL_C=:email WHERE ID_C=:id;");
        query.bindValue(":nom", nom_c);
        query.bindValue(":prenom", prenom_c);
        query.bindValue(":id", id_c);
        query.bindValue(":sexe",sexe_c);
